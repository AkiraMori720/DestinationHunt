    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <AppHeader
              ...
              rightIconOnePath={Constants.user?.favorbids?.includes(businessItem.id)? Images.ic_favorite_active : Images.ic_favorite_inactive}
              rightTintColor={Constants.user?.favorbids?.includes(businessItem.id)? Colors.gold : Colors.colorGrey}
              onLeftIconPress={() => {
                Constants.refreshFlag = true;
                if (Constants.backRoute == 'Profile') navigation.navigate('Profile');
                else navigation.goBack(null);
              ...
              onRightIconPress={() => {
                if (Constants.user) {
                  //setReviewModal(!reviewModal);
                  onBookmarkBusinessItem(businessItem,Constants.user?.favorbids?.includes(businessItem.id) ? 'delete' : 'add');
                }
                else {
                  showAlert();
                }
