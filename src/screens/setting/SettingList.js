  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.itemLine}>
        ...
        }}><Text style={styles.itemTxt}>Notifications</Text></TouchableOpacity>
        <View style={styles.iconPart}><Switch
              trackColor={{false: Colors.blue_button, true: Colors.blue_button}}
              thumbColor={Colors.white}
              ios_backgroundColor={Colors.blue_button}
      ...
      <View style={styles.itemLine}>
        <View style={styles.iconPart}>
        <Image resizeMode="contain" style={{height: 17, width: 17, tintColor:Colors.yellowToneColor}}
                            source={Images.ic_contact} />
        {/* <EntypoIcon name="info" style={styles.iconLabel}></EntypoIcon> */}</View>
      ...
      <View style={styles.itemLine}>
        <View style={styles.iconPart}><EntypoIcon name="info" style={styles.iconLabel}></EntypoIcon></View>
      ...
      {
        (Constants.user && !Constants.user?.bid) &&
        <View style={styles.itemLine}>
...

      {
        ...
        <View style={styles.itemLine}>
          <View style={styles.iconPart}><EntypoIcon name="suitcase" style={styles.iconLabel}></EntypoIcon></View>
          <TouchableOpacity style={styles.titlePart} onPress={() => { Constants.refreshFlag = true; navigation.navigate('Request'); }}><Text style={styles.itemTxt}>Edit Business Account</Text></TouchableOpacity>
          <View style={styles.iconPart}><EntypoIcon name="chevron-thin-right" style={styles.itemTxt}></EntypoIcon></View>
        </View>
      }

      {
        (Constants.mode !== 'business' && Constants.user?.bid) &&
        <View style={styles.itemLine}>
