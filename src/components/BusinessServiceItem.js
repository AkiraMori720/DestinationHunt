...
export default function ServiceItem({ item, onPress, onEdit, onDelete, showAlert }) {

  const getReviewLength = (item) => {
        ...
        <View style={styles.topLine}>
          ...
          <View style={styles.buttonStyle}>
            <TouchableOpacity onPress={() => onEdit(item)}>
                <EntypoIcon name="edit" style={[styles.iconBookmark, {marginLeft:normalize(0), color: Colors.dark_grey }]}></EntypoIcon>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => onDelete(item)}>
                <EntypoIcon name="trash" style={[styles.iconBookmark, {marginLeft:normalize(10), color: Colors.dark_grey }]}></EntypoIcon>
            </TouchableOpacity>
          </View>
        </View>
