...
export default class TabComponent extends React.Component {
    ...
    onLeftPress = () => {
        if (this.state.leftBgColor === 'transparent') {
            this.setState({ leftBgColor:Colors.blue_button, middleBgColor:'transparent',rightBgColor:'transparent'})
        }
    ...
    onMiddlePress = () => {
        if (this.state.middleBgColor === 'transparent') {
            this.setState({ leftBgColor:'transparent', middleBgColor:Colors.blue_button,rightBgColor:'transparent'})
        }
    ...
    onRightPress = () => {
        if (this.state.rightBgColor === 'transparent') {
            this.setState({ leftBgColor:'transparent', middleBgColor:'transparent',rightBgColor:Colors.blue_button})
        }
        ...
        return (
            <View style={styles.mainContainer} >
                ...
                <View style={{ flexDirection: 'row', justifyContent: "center", alignItems: "center" }}>
                    ...
                    <Image style={{height:20,width:20,resizeMode:'contain'}} source={Images.ic_hunt} />
                    ...
                    <TouchableOpacity onPress={() => this.onMiddlePress()} style={{
                        ...
                        <Image style={{height:20,width:20,resizeMode:'contain'}} source={Images.ic_stay} />
                    ...
                    <TouchableOpacity onPress={() => this.onRightPress()} style={{
                        backgroundColor: this.state.rightBgColor,
                        width: wp(33.3)
                        , height: hp(7),
                        justifyContent: "center",
                        alignItems: "center",
                        ...
                        <Image style={{height:20,width:20,resizeMode:'contain'}} source={Images.ic_explore} />

                        <Text style={{ color: this.state.rightTextColor,paddingLeft:'6%', fontSize: wp(4.3),fontWeight:'bold' }}>{this.props.rightText}</Text>
                    </TouchableOpacity>
